...
//-----------------------------------------------------------------------
// Summary:
//     XTPShortcutBarPaintTheme is an enumeration used by CXTPShortcutBar to set the theme of the
//     control.
// Example:
// <code>
...
public:
	...
	CXTPPaintManagerColorGradient m_grcHot; // Color gradient of "hot" items.  And item is hot when
											// the mouse cursor is positioned over the item.
	CXTPPaintManagerColorGradient m_grcPushed; // Color gradient of item when clicked on.  This
											   // color is also used to color the currently selected
											   // item on mouse over.  I.e. When the selected item
											   // is "hot."
