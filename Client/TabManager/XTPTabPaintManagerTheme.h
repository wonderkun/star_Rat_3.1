...
public:
	...
	// See Also: CXTPTabPaintManager::SetFontIndirect, GetHeaderMargin, GetClientMargin,
	// GetButtonLength, GetButtonHeight
	//-----------------------------------------------------------------------
	...
	// See Also: XTPTabColorStyle, CXTPTabPaintManager::GetColor, CXTPTabPaintManager::SetColorSet,
	// CXTPTabPaintManager::SetColor
	//-----------------------------------------------------------------------
	...
	// See Also: GetHeaderRect, GetClientRect, GetHeaderMargin, GetClientMargin,
	...
	// See Also: CXTPTabPaintManager::m_rcButtonMargin, GetClientMargin, GetHeaderMargin,
	// CXTPTabPaintManager::DrawSingleButtonIconAndText, CXTPTabManager::GetItemMetrics,
	// GetButtonHeight
	//-----------------------------------------------------------------------
	...
	// See Also: CXTPTabPaintManager.CXTPTabPaintManagerTheme.m_nButtonHeight,
...
public:
	...
	// See Also: GetHeaderRect, CXTPTabPaintManager::m_bFillBackground, XTPTabClientFrame,
...
public:
	...
	COLORREF FillButton(CDC* pDC, CXTPTabManagerItem* pItem, LPPOINT pts, int nCount,
						XTPTabPosition tabPosition, BOOL bAbsoulute = FALSE);
...
public:
	CRect m_rcHeaderMargin; // CRect struct containing the left, top, right, and bottom margins of
							// the tab header.  This is the margin (space) placed around the tab
							// buttons inside the tab header.
