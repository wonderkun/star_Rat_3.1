...
void CXTPTabPaintManager::CAppearanceSet::DrawText(CDC* pDC, CXTPTabManager* /*pManager*/, const CString& str, LPRECT lpRect, UINT nFormat)
{
...
CRect CXTPTabPaintManager::CAppearanceSet::GetHeaderClipBox(CDC* pDC, CXTPTabManager* pTabManager)
{
	CRect rcClipBox;
...
void CXTPTabPaintManager::CAppearanceSetPropertyPageFlat::DrawSingleButton(CDC* pDC, CXTPTabManagerItem* pItem)
{
	...
	if (m_bBlurPoints)
	{
		COLORREF clrBackground = GetColorSet()->m_clrHeaderFace;
		COLORREF clrBorder = GetColorSet()->m_clrFrameBorder;
