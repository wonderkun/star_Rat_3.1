...
public:
	...
	//     CXTPTabManager::GetItemColor for the currently selected tab is returned, otherwise
...
protected:
	CXTPWinThemeWrapper* m_themeTabButton; // Internally used helper to draw PropertyPage Buttons
										   // using Windows XP color set.
	CXTPWinThemeWrapper* m_themeToolbar;   // Internally used helper to draw State Button using
