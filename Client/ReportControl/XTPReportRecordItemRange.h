...
public:
	...
	CXTPReportRecordItemRange(int nColumnFrom, int nColumnTo, int nRecordFrom, int nRecordTo);
...
class _XTP_EXT_CLASS CXTPReportRecordMergeItems
	: public CMap<CXTPReportRecordItem*, CXTPReportRecordItem*, CXTPReportRecordMergeItem,
				  CXTPReportRecordMergeItem&>
{
};
