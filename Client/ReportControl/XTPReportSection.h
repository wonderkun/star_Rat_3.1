...
public:
	...
	virtual void CXTPReportSection::AddRecordEx(CXTPReportRecord* pRecord,
...
AFX_INLINE void
	CXTPReportSection::SetDividerPosition(XTPReportSectionDividerPosition dividerPosition)
{
