	...
	: m_strCaption(szCaption)
{
	...
	m_clrCaption = GetXtremeColor(COLOR_BTNTEXT);
...
int CXTPReportRecordItemControl::GetIconIndex(int nState)
{
...
//>>attempt for 23588 issue case
	...
	if (m_rcControl.PtInRect(pClickArgs->ptClient)
		&& pClickArgs->pControl
		&& m_rcControl.PtInRect(pClickArgs->pControl->m_ptMouseDown))
	{
