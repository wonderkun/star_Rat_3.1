...
public:
	...
	BOOL m_bRepeatHeaderRows; // If TRUE - the header rows will be printed on every page. FALSE by
							  // default.
	BOOL m_bRepeatFooterRows; // If TRUE - the footer rows will be printed on every page. FALSE by
							  // default.
...
public:
	...
	enum
	{
		IDD = XTP_IDD_REPORT_PRINT_PAGE_SETUP
	};
	//}}AFX_CODEJOCK_PRIVATE
