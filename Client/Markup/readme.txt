...
Polygon            (Width, Margin, ClipToBounds, HorizontalAlignment, VerticalAlignment, Width, Height, MinWidth, MaxWidth, MinHeight, Points, Fill)
Polyline           (Width, Margin, ClipToBounds, HorizontalAlignment, VerticalAlignment, Width, Height, MinWidth, MaxWidth, MinHeight, Points, Fill)
