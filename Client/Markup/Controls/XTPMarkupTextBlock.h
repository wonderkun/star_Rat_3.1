...
//===========================================================================
// Summary: CXTPMarkupTextBlock is CXTPMarkupFrameworkElement derived class. It implements TextBlock
// XAML Tag.
//===========================================================================
...
public:
	...
	// Remarks: The TextTrimming property has no effect unless the TextWrapping property is set to
	// NoWrap
	//-----------------------------------------------------------------------
	...
	//     content area, and the content displayed by a TextBlock
	// Returns:
