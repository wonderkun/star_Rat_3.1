...
#	define XTP_SAFE_GET3(_ptr1, _ptr2, _ptr3, _member, _defVal)                                   \
		((_ptr1 && _ptr1->_ptr2 && _ptr1->_ptr2->_ptr3) ? _ptr1->_ptr2->_ptr3->_member : (_defVal))
#	define XTP_SAFE_GET4(_ptr1, _ptr2, _ptr3, _ptr4, _member, _defVal)                            \
		((_ptr1 && _ptr1->_ptr2 && _ptr1->_ptr2->_ptr3 && _ptr1->_ptr2->_ptr3->_ptr4)              \
			 ? _ptr1->_ptr2->_ptr3->_ptr4->_member                                                 \
			 : (_defVal))
#	define XTP_SAFE_GET5(_ptr1, _ptr2, _ptr3, _ptr4, _ptr5, _member, _defVal)                     \
		((_ptr1 && _ptr1->_ptr2 && _ptr1->_ptr2->_ptr3 && _ptr1->_ptr2->_ptr3->_ptr4               \
		  && _ptr1->_ptr2->_ptr3->_ptr4->_ptr5)                                                    \
...
#	define XTP_SAFE_CALL4(_ptr1, _ptr2, _ptr3, _ptr4, _member)                                    \
		if (_ptr1 && _ptr1->_ptr2 && _ptr1->_ptr2->_ptr3 && _ptr1->_ptr2->_ptr3->_ptr4)            \
		{                                                                                          \
			_ptr1->_ptr2->_ptr3->_ptr4->_member;                                                   \
		}
...
#	define _XTP_DEPRECATED                                                                        \
		_XTP_DEPRECATE("Deprecated in " XTP_STRINGIZE(_XTPLIB_VERSION_MAJOR) "." XTP_STRINGIZE(    \
