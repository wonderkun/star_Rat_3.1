...
CString CXTPResourceImages::_ImageNameToResourceName(CString strImageFile)
{
...
CXTPResourceImage* CXTPResourceImages::LoadImage(CString strImageFile)
{
...
COLORREF CXTPResourceImages::GetImageColor(CString strSectionName, CString strKeyName, COLORREF clrDefault)
{
...
CRect CXTPResourceImages::GetImageRect(CString strSectionName, CString strKeyName, CRect rcDefault)
{
	CString strValue = GetImageValue(strSectionName, strKeyName);
	if (strValue.IsEmpty())
		return rcDefault;
...
int CXTPResourceImages::GetImageInt(CString strSectionName, CString strKeyName, int nDefault)
{
	CString strValue = GetImageValue(strSectionName, strKeyName);
	if (strValue.IsEmpty())
		return nDefault;
...
CString CXTPResourceImages::GetImageString(CString strSectionName, CString strKeyName)
{
	return GetImageValue(strSectionName, strKeyName);
}

CString CXTPResourceImages::GetImageValue(CString strSectionName, CString strKeyName)
{
...
void CXTPResourceImages::RefreshSettings()
{
	CString str;
