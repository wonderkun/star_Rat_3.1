...
protected:
	...
	//                        resource.
	//-----------------------------------------------------------------------
	explicit CXTPDialogScrollBarContainer(LPCTSTR lpszTemplateName, CWnd* pParentWnd = NULL)
	{
	...
	//-----------------------------------------------------------------------
	explicit CXTPDialogScrollBarContainer(UINT nIDTemplate, CWnd* pParentWnd = NULL)
	{
