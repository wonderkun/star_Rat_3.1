...
//-----------------------------------------------------------------------
// Summary: Creates a read-only stream on a block of memory.
// Parameters:
...
//-----------------------------------------------------------------------
// Summary: Creates a read-only stream on the file specified.
// Parameters:
//     lpPath - File path.
//     ppStream - Output pointer that receives stream pointer.
// Returns: S_OK if successful or a standard COM error code.
...
//-----------------------------------------------------------------------
// Summary: Creates a read-only stream on a resource.
// Parameters:
...
public:
	...
	//      lpme - A pointer to a MODULEENTRY32 structure.
	// Returns:
	//      Returns TRUE if the next entry of the module list has been copied to the buffer or FALSE
	//      otherwise.
	// See also:
	//      GetFirstModule
	//-----------------------------------------------------------------------
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//      Creates a global atom object using the provided name. If atom
	//      with such a name already exists its reference counter will be incremented.
	// Parameters:
	...
	//      and if it reaches zero the atom object will be destroyed.
	//-----------------------------------------------------------------------
	~CXTPGlobalAtom();
	...
	// Returns:
	//      Atom value as a string. The value must not be used for string operations
	//      except where permitted by SDK documentation.
	//-----------------------------------------------------------------------
