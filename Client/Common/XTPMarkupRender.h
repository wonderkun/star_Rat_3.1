...
// Remarks:
//     XTPMarkupCreateContext creates new CXTPMarkupContext that holds common properties of Markup
//     Elements like default font, default text color, current selected element, etc.
// Example:
// <code>
//     CXTPMarkupContext* pContext = XTPMarkupCreateContext();
//     pContext->SetDpiAware();
//     CXTPMarkupUIElement* pElement = XTPMarkupParseText(pContext, "<Ellipse Fill='Red' Width='100'
//     Height='100'/>"); CSize sz = XTPMarkupMeasureElement(pElement);
...
// Example:
//     See Example for XTPMarkupCreateContext function
// See Also: XTPMarkupCreateContext, XTPMarkupReleaseElement, XTPMarkupMeasureElement,
// XTPMarkupRenderElement
//-----------------------------------------------------------------------
_XTP_EXT_CLASS CXTPMarkupUIElement* AFX_CDECL XTPMarkupParseText(CXTPMarkupContext* pContext,
																 LPCSTR lpszMarkup);
_XTP_EXT_CLASS CXTPMarkupUIElement* AFX_CDECL XTPMarkupParseText(CXTPMarkupContext* pContext,
																 LPCWSTR lpszMarkup);
_XTP_EXT_CLASS CXTPMarkupUIElement* AFX_CDECL XTPMarkupParseText(CXTPMarkupContext* pContext,
...
//-----------------------------------------------------------------------
_XTP_EXT_CLASS CSize AFX_CDECL XTPMarkupMeasureElement(CXTPMarkupUIElement* pElement,
													   int cxAvail = INT_MAX,
													   int cyAvail = INT_MAX);
...
//     rc         - Pointer to a RECT structure that contains the rectangle in which the element is
//     to be formatted
// Example:
//     See Example for XTPMarkupCreateContext function
// See Also: XTPMarkupCreateContext, XTPMarkupParseText, XTPMarkupMeasureElement
//-----------------------------------------------------------------------
_XTP_EXT_CLASS void AFX_CDECL XTPMarkupRenderElement(CXTPMarkupUIElement* pElement, HDC hDC,
													 LPCRECT rc);

//-----------------------------------------------------------------------
// Summary:
//     XTPMarkupSetDefaultFont is part of Markup API. Call it to set default font and text color for
//     Markup elements
// Parameters:
...
// See Also: XTPMarkupCreateContext, XTPMarkupParseText, XTPMarkupMeasureElement
//-----------------------------------------------------------------------
_XTP_EXT_CLASS void AFX_CDECL XTPMarkupSetDefaultFont(CXTPMarkupContext* pContext, HFONT hFont,
													  COLORREF clrText);

//-----------------------------------------------------------------------
// Summary:
//     XTPMarkupRelayMessage is part of Markup API. It used to notify Markup element about events of
//     associated window.
// Parameters:
...
// See Also: XTPMarkupCreateContext
//-----------------------------------------------------------------------
_XTP_EXT_CLASS BOOL AFX_CDECL XTPMarkupRelayMessage(CXTPMarkupUIElement* pElement, UINT message,
													WPARAM wParam, LPARAM lParam, LRESULT* pResult);
_XTP_EXT_CLASS BOOL AFX_CDECL XTPMarkupRelayMessage(CXTPMarkupContext* pContext, UINT message,
													WPARAM wParam, LPARAM lParam, LRESULT* pResult);
...
_XTP_EXT_CLASS void AFX_CDECL XTPMarkupDrawText(CXTPMarkupContext* pContext, HDC hDC,
												LPCTSTR lpszText, LPRECT lpRect, UINT nFormat);
