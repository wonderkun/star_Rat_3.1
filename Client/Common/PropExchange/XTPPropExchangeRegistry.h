...
//     The CXTPPropExchangeRegistry class allows you to save a complex network of objects in a
//     system registry that persists after those objects are deleted. Later you can load the objects
//     from persistent storage, reconstituting them in memory. This process of making data
