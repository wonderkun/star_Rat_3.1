...
//     The CXTPPropExchangeXMLNode class allows you to save a complex network of objects in a XML
...
public:
	...
	// Parameters:
	//     lpszFileName -   A CString value that contains the name of a file to be loaded into the
	//     XML
	// Returns:
...
protected:
	...
	//     value is to be written. bCreate - TRUE to create if doesn't exist;
	// Returns:
