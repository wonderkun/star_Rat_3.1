...
//     The CXTPPropExchangeArchive class allows you to save a complex network of objects in a
//     permanent binary form (usually disk storage) that persists after those objects are deleted.
...
public:
	...
	// Parameters:
	//     ar - A reference to the CArchive object that is the ultimate source or destination of the
	//     persistent data.
	//-----------------------------------------------------------------------
...
private:
	CXTPPropExchangeArchive& operator=(const CXTPPropExchangeArchive&)
	{
		ASSERT(FALSE);
		return *this;
	}
