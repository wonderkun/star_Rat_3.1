...
private:
	...
	typedef CMap<const CXTPRWCriticalSection*, const CXTPRWCriticalSection*, long, long>
		LocalSharedLockCounterMap;
	//}}AFX_CODEJOCK_PRIVATE
};
...
public:
	...
	//---------------------------------------------------------------------------
	explicit CSharedLock(CXTPRWCriticalSection& cs)
		: m_pCS(&cs)
	{
		m_pCS->LockShared();
	}
	...
	//{{AFX_CODEJOCK_PRIVATE
public:
	CSharedLock(CXTPRWCriticalSection* pCS, XTPDetails::XTPSynchroPrivateUseTag)
		: m_pCS(pCS)
	{
		if (NULL != m_pCS)
		{
...
public:
	...
	//---------------------------------------------------------------------------
	explicit CExclusiveLock(CXTPRWCriticalSection& cs)
		: m_pCS(&cs)
	{
		m_pCS->LockExclusive();
	}
	...
	//{{AFX_CODEJOCK_PRIVATE
public:
	CExclusiveLock(CXTPRWCriticalSection* pCS, XTPDetails::XTPSynchroPrivateUseTag)
		: m_pCS(pCS)
	{
		if (NULL != m_pCS)
		{
...
public:
	...
	//---------------------------------------------------------------------------
	CXTPAsyncGuard(Adaptee& adaptee, CXTPRWCriticalSection& cs)
		: m_locker(cs)
		, m_adaptee(adaptee)
	...
	//---------------------------------------------------------------------------
	CXTPAsyncGuard(Adaptee& adaptee, CXTPRWCriticalSection& cs, long& nConditionCounter)
		: m_locker(1 == InterlockedIncrement(&nConditionCounter) ? &cs : NULL,
...
struct XTPAsyncGuardShortcut
{
	...
	typedef CXTPAsyncGuard<const T, CXTPRWCriticalSection::CExclusiveLock>
		XTPAsyncConstExclusiveGuard;
};
...
//---------------------------------------------------------------------------
template<class T>
AFX_INLINE CXTPAsyncGuard<T, CXTPRWCriticalSection::CSharedLock> XTPAccessShared(T* pObject)
{
	ASSERT(NULL != pObject);
	return CXTPAsyncGuard<T, CXTPRWCriticalSection::CSharedLock>(
		*pObject, pObject->CXTPSynchronized::GetAccessCriticalSection());
}
...
//---------------------------------------------------------------------------
template<class T>
AFX_INLINE CXTPAsyncGuard<T, CXTPRWCriticalSection::CExclusiveLock> XTPAccessExclusive(T* pObject)
{
	ASSERT(NULL != pObject);
	return CXTPAsyncGuard<T, CXTPRWCriticalSection::CExclusiveLock>(
		*pObject, pObject->CXTPSynchronized::GetAccessCriticalSection());
}
...
#	define XTP_GUARD_SHARED_(Type, Object, Guard)                                                 \
		XTP_BLOCKSTATEMENT(::XTPDetails::XTPAsyncGuardShortcut<Type>::XTPAsyncSharedGuard, Guard,  \
						   XTPAccessShared(Object))
...
#	define XTP_GUARD_SHARED_COND_(Type, Object, Guard, ConditionCounter)                          \
		XTP_BLOCKSTATEMENT(::XTPDetails::XTPAsyncGuardShortcut<Type>::XTPAsyncSharedGuard, Guard,  \
						   XTPAccessShared(Object, ConditionCounter))
...
//     Object - Synchronized object pointer
//---------------------------------------------------------------------------
#	define XTP_GUARD_SHARED(Type, Object) XTP_GUARD_SHARED_(Type, Object, $__xtpGuard)
...
#	define XTP_GUARD_SHARED_CONST_(Type, Object, Guard)                                           \
		XTP_BLOCKSTATEMENT(::XTPDetails::XTPAsyncGuardShortcut<Type>::XTPAsyncConstSharedGuard,    \
						   Guard, XTPAccessShared(Object))
...
#	define XTP_GUARD_SHARED_COND_CONST_(Type, Object, Guard, ConditionCounter)                    \
		XTP_BLOCKSTATEMENT(::XTPDetails::XTPAsyncGuardShortcut<Type>::XTPAsyncConstSharedGuard,    \
						   Guard, XTPAccessShared(Object, ConditionCounter))
...
//     Object - Synchronized object pointer
//---------------------------------------------------------------------------
#	define XTP_GUARD_SHARED_CONST(Type, Object) XTP_GUARD_SHARED_CONST_(Type, Object, $__xtpGuard)
...
#	define XTP_GUARD_EXCLUSIVE_(Type, Object, Guard)                                              \
		XTP_BLOCKSTATEMENT(::XTPDetails::XTPAsyncGuardShortcut<Type>::XTPAsyncExclusiveGuard,      \
						   Guard, XTPAccessExclusive(Object))
...
#	define XTP_GUARD_EXCLUSIVE_COND_(Type, Object, Guard, ConditionCounter)                       \
		XTP_BLOCKSTATEMENT(::XTPDetails::XTPAsyncGuardShortcut<Type>::XTPAsyncExclusiveGuard,      \
						   Guard, XTPAccessExclusive(Object, ConditionCounter))
...
//     Object - Synchronized object pointer
//---------------------------------------------------------------------------
#	define XTP_GUARD_EXCLUSIVE(Type, Object) XTP_GUARD_EXCLUSIVE_(Type, Object, $__xtpGuard)
...
#	define XTP_GUARD_EXCLUSIVE_CONST_(Type, Object, Guard)                                        \
		XTP_BLOCKSTATEMENT(::XTPDetails::XTPAsyncGuardShortcut<Type>::XTPAsyncConstExclusiveGuard, \
						   Guard, XTPAccessExclusive(Object))
