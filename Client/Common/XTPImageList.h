...
public:
	...
	//     operation. iSrc - The zero-based index of the image to be used as the source of the copy
	//     operation. uFlags - The bit flag value that specifies the type of copy operation to be
	//     made.
	// Returns:
	//     Nonzero if successful; otherwise zero.
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//     iDst - The zero-based index of the image to be used as the destination of the copy
	//     operation. pSrc - A pointer to a CXTPImageList object that is the target of the copy
	//     operation. iSrc - The zero-based index of the image to be used as the source of the copy
	//     operation. uFlags - The bit flag value that specifies the type of copy operation to be
	//     made.
	// Returns:
