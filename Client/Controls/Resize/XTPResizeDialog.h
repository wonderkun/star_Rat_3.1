...
public:
	...
	//     lpszTemplateName - Contains a null-terminated string that is the name of a dialog-box
	//     template resource. pParent - Points to the parent or owner window object of type CWnd,
	//     which
...
public:
	//-----------------------------------------------------------------------
	// Summary:
	//     Constructs a CXTPResizeDHtmlDialog object
	// Parameters:
	//     nID     - Contains the ID number of a dialog box template resource.
	//     lpszTemplateName - Contains a null-terminated string that is the name of a dialog-box
	//     template resource. nHtmlResID - Contains the ID number of an HTML resource. szHtmlResID -
	//     The null - terminated string that is the name of an HTML resource. pParent - Points to
	//     the parent or owner window object of type CWnd, which
	//               the dialog object belongs to. If it is NULL, the dialog object's parent
	//               window is set to the main application window.
	//     nFlags  - Flags that are to be passed to CXTPResize that specify the attributes
	//               of the resizing property page. They can be one or more of the values
