...
public:
	...
	//     lpszTemplateName - Points to a string containing the name of the template for this page.
	//     Cannot be NULL nIDCaption - ID of the name to be placed in the tab for this page. If 0,
