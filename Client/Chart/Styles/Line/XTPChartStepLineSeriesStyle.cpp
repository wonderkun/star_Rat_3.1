...
CXTPChartDeviceCommand* CXTPChartStepLineSeriesView::CreateLegendDeviceCommand(CXTPChartDeviceContext* pDC, CRect rcBounds)
{
	...
	pCommand->AddChildCommand(new CXTPChartSolidLineDeviceCommand(CXTPChartDiagramPoint(rcBounds.left, rcBounds.bottom),
		CXTPChartDiagramPoint(rcBounds.left, ptCenter.Y), GetColor(), 1));
	pCommand->AddChildCommand(new CXTPChartSolidLineDeviceCommand(CXTPChartDiagramPoint(rcBounds.left, ptCenter.Y),
		CXTPChartDiagramPoint(rcBounds.right, ptCenter.Y), GetColor(), 1));
	pCommand->AddChildCommand(new CXTPChartSolidLineDeviceCommand(CXTPChartDiagramPoint(rcBounds.right, ptCenter.Y),
		CXTPChartDiagramPoint(rcBounds.right, rcBounds.top), GetColor(), 1));
...
CXTPChartDeviceCommand* CXTPChartStepLineSeriesPointView::CreateLegendDeviceCommand(CXTPChartDeviceContext* pDC, CRect rcBounds)
{
	...
	pCommand->AddChildCommand(new CXTPChartSolidLineDeviceCommand(CXTPChartDiagramPoint(rcBounds.left, rcBounds.bottom),
		CXTPChartDiagramPoint(rcBounds.left, ptCenter.Y), GetSeriesView()->GetColor(), 1));
	pCommand->AddChildCommand(new CXTPChartSolidLineDeviceCommand(CXTPChartDiagramPoint(rcBounds.left, ptCenter.Y),
		CXTPChartDiagramPoint(rcBounds.right, ptCenter.Y), GetSeriesView()->GetColor(), 1));
	pCommand->AddChildCommand(new CXTPChartSolidLineDeviceCommand(CXTPChartDiagramPoint(rcBounds.right, ptCenter.Y),
		CXTPChartDiagramPoint(rcBounds.right, rcBounds.top), GetSeriesView()->GetColor(), 1));
