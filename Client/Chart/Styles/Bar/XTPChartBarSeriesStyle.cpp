...
CXTPChartBarSeriesStyle::CXTPChartBarSeriesStyle()
{
	...
	m_pFillStyle->SetGradientDirection(xtpChartGradientRightToLeft);
...
CXTPChartRectF CXTPChartBarSeriesPointView::GetScreenRect() const
{
	...
	CXTPChartAxisView* pAxisYView = pSeriesView->GetAxisViewY();
...
{
	CXTPChartDiagram2DView* pDiagramView = (CXTPChartDiagram2DView*)GetSeriesView()->GetDiagramView();
