...
public:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this function to get the primary diagram of the chart. Its the diagram of first
	//     Panel.
	// Returns:
...
public:
	...
	//     A CXTPChartColor object which describes an ARGB value.
	// Remarks:
	//     Call SetBackgroundColor to set custom background color. If custom background not set -
	//     color from current appearance will be used.
	//-----------------------------------------------------------------------
...
public:
	...
	// Returns:
	//     XTPChartPanelDirection value indicates direction of panels
	...
	// Parameters:
	//     nDirection - XTPChartPanelDirection value indicates direction of panels
	//     (xtpChartPanelVertical/xtpChartPanelHorizontal)  //
	//-----------------------------------------------------------------------
