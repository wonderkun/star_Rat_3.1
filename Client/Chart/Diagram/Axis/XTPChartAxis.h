...
public:
	...
	//-------------------------------------------------------------------------
	// Summary:
	//     This is the override of base the class member,tells that whether the X axis is value
	//     type.
	// Returns:
...
public:
	...
	//-------------------------------------------------------------------------
	// Summary:
	//     This is the override of base the class member,tells that whether the Y axis is value
	//     type.
	// Returns:
