...
CXTPChartColor CXTPChartAxisStrip::GetActualColor() const
{
	...
	return GetContent()->GetAppearance()->GetDiagram2DAppearance()->GetAxisAppearance()->StripColor;
}
...
CXTPChartColor CXTPChartAxisStrip::GetActualColor2() const
{
	...
	return GetContent()->GetAppearance()->GetDiagram2DAppearance()->GetAxisAppearance()->StripColor2;
}
