...
CXTPChartAxis::CXTPChartAxis(CXTPChartDiagram2D* pDiagram)
{
	m_pDiagram = pDiagram;
	m_pOwner = pDiagram;
...
CXTPChartAxisView* CXTPChartAxis::CreateView(CXTPChartDeviceContext* pDC, CXTPChartElementView* pParentView)
{
	...
	CXTPChartAxisView* pView = new CXTPChartAxisView(this, pParentView);
...
{
	return m_pDiagram->GetAppearance()->GetAxisAppearance();
}
