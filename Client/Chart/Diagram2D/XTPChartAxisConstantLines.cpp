...
CXTPChartColor CXTPChartAxisConstantLine::GetActualTextColor() const
{
	...
	return GetContent()->GetAppearance()->GetDiagram2DAppearance()->GetAxisAppearance()->ConstantLineTextColor;
}
...
CXTPChartColor CXTPChartAxisConstantLine::GetActualColor() const
{
	...
	return GetContent()->GetAppearance()->GetDiagram2DAppearance()->GetAxisAppearance()->ConstantLineColor;
}
