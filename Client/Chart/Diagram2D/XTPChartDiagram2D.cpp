...
CXTPChartDiagram2D::CXTPChartDiagram2D()
{
	...
	m_pPane = new CXTPChartDiagramPane(this);
...
void CXTPChartDiagram2D::SetPane(CXTPChartDiagramPane* pPane)
{
	if (m_pPane != pPane)
	{
...
{
	return GetContent()->GetAppearance()->GetDiagram2DAppearance();
}
...
{
	return XTPGetDispatch(m_pPane->GetFillStyle());
}
