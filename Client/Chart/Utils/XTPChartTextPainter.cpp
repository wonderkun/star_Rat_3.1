...
{
	double fPI = CXTPChartMathUtils::PI;
...
//////////////////////////////////////////////////////////////////////////
// CXTPChartRotatedTextPainterOnCircleRadial

CXTPChartRotatedTextPainterOnCircleRadial::CXTPChartRotatedTextPainterOnCircleRadial(CXTPChartDeviceContext* pDC, const CXTPChartString& text, CXTPChartTextElement* pTextProvider, CPoint ptBase, float fAngle)
	: CXTPChartRotatedTextPainterBase(pDC, text, pTextProvider, ptBase)
{
	fAngle = (float)CXTPChartMathUtils::NormalizeDegree(fAngle);

	m_fAngle = fAngle <= 180 ? fAngle - 90 : fAngle + 90;
}

CPoint CXTPChartRotatedTextPainterOnCircleRadial::CalculateLeftTopPoint()
{
	return CPoint(m_ptBasePoint.x - m_nWidth / 2, m_ptBasePoint.y - m_nHeight / 2);
}

XTPChartTextRotation CXTPChartRotatedTextPainterOnCircleRadial::CalculateRotation()
{
	return xtpChartTextCenterCenter;
}
