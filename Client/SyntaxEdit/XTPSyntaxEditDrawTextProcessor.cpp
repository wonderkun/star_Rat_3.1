...
BOOL CXTPSyntaxEditDrawTextProcessor::HitTest(const CPoint& pt, int& rnRow, int& rnCol, BOOL bVirtualSpace)
{
...
BOOL CXTPSyntaxEditDrawTextProcessor::HitTestRow(int nY, int& rnRow)
{
