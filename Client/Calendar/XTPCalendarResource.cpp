...
CXTPCalendarResource* CXTPCalendarResources::Find(CXTPCalendarEvent* pEvent)
{
...
CXTPCalendarEventsPtr CXTPCalendarResources::RetrieveDayEvents(COleDateTime dtDay)
{
