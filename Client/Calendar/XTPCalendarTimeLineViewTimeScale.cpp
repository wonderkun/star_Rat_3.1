...
BOOL CXTPCalendarTimeLineViewTimeScale::HitTestEx(CPoint pt, XTP_CALENDAR_HITTESTINFO* pHitTest)
{
...
COleDateTimeSpan CXTPCalendarTLV_TimeScaleParams::GetScaleInterval()
{
