...
{
	((CXTPCalendarMonthView*) GetMonthView())->SetLongDayHeaderFormat(pcszCustomFormat);
}

void CXTPCalendarControl::SetSmallDayHeaderFormat(LPCTSTR pcszCustomFormat)
{
	((CXTPCalendarMonthView*) GetMonthView())->SetSmallDayHeaderFormat(pcszCustomFormat);
}
...
CXTPCalendarView* CXTPCalendarControl::GetTimeLineView()
{
