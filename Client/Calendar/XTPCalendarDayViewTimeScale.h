...
public:
	...
	// Remarks:
	//    This function overrides locale time format for calendar control. To reset time format back
	//    to locale call ResetCustomTimeFormat()
	//
	//-----------------------------------------------------------------------
...
protected:
	...
	CButton m_btnAutoAdjustDayLight1; // A check box control to show 'Auto Adjust Day Light' option
									  // for main timezone
	...
	CButton m_btnAutoAdjustDayLight2; // A check box control to edit 'Auto Adjust Day Light' option
									  // for additional timezone

	BOOL m_bAutoAdjustDayLight2; // A BOOL member which used to edit 'Auto Adjust Day Light' option
								 // for additional timezone
