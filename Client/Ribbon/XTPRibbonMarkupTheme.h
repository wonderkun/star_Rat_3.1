...
protected:
	...
	CString m_strHighlightedPrefix; // The prfix of file name for backstage "back" button image
									// using for selected button
	CString m_strNormalPrefix; // The prfix of file name for backstage "back" button image using for
							   // not selected button
