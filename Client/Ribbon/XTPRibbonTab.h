...
public:
	...
	//     Collection of CXTPRibbonGroup objects that have been added to
	//     the CXTPRibbonTab
	// See Also: CXTPRibbonGroups::GetAt, CXTPRibbonGroups::InsertAt, CXTPRibbonGroups::Add,
	...
	// See Also: CXTPRibbonGroup::SetCaption, CXTPRibbonGroup::SetCaption, CXTPRibbonTab,
