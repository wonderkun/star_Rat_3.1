...
CXTPDockingPaneVisualStudio2010Theme::CXTPDockingPaneVisualStudio2010Theme()
{
	...
	CXTPTabPaintManager::CAppearanceSetPropertyPageFlat* pAppearance =
		new CXTPTabPaintManager::CAppearanceSetPropertyPageFlat();
	pAppearance->m_bBlurPoints = TRUE;
	pAppearance->m_bVisualStudio2005Style = FALSE;
	pAppearance->m_bDrawNormalTab = FALSE;
	pAppearance->m_rcHeaderMargin.left = -1;
	pAppearance->m_rcHeaderMargin.right = 1;
	...
	GetPanelPaintManager()->GetAppearanceSet()->m_rcHeaderMargin.left = 0;
...
void CXTPDockingPaneVisualStudio2010Theme::RefreshMetrics()
{
	...
	m_clrActiveCaption.SetStandardValue(RGB(255, 252, 242), RGB(255, 232, 166));
	m_clrCaptionBorder = RGB(41, 57, 85);
