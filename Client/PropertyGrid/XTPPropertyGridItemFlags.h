...
// </code>
//
// See Also: CXTPPropertyGridItemFlags::SetFlags, CXTPPropertyGridItemFlags::GetFlags,
...
protected:
	int m_nValue; // Value of the item.  This is the sum of the constraint values that have a value
				  // of TRUE.
