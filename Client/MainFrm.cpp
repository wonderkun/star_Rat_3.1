...
BOOL CMainFrame::PreCreateWindow(CREATESTRUCT& cs)
{
	...
	cs.lpszName = _T("Star Rat 3.1免杀远控[独特论坛专用版]");
	return TRUE;
}
...
void CMainFrame::OnSysCommand(UINT nID, LPARAM lParam)
{
	if (nID == SC_MINIMIZE)
	{
		...
		m_TrayIcon.ShowBalloonTip( _T(zVDrT), _T("Star Rat 3.1免杀远控[独特论坛专用版]"), NIIF_NONE, 5);
	}
	else
	{
...
{	
	m_TrayIcon.ShowBalloonTip( lpszText, _T("新上线主机信息: "), NIIF_NONE, 5);
}
