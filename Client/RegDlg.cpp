...
BOOL CRegDlg::OnInitDialog() 
{
	...
	str.Format("\\\\%s - Regedit Manager", bResult != INVALID_SOCKET ? inet_ntoa(sockAddr.sin_addr) : "");
	SetWindowText(str);

	size[0]=120;size[1]=80;size[2]=310;
	m_list.InsertColumn(0,"Name",LVCFMT_LEFT,size[0],-1);
	m_list.InsertColumn(1,"Types",LVCFMT_LEFT,size[1],-1);
	m_list.InsertColumn(2,"Data",LVCFMT_LEFT,size[2],-1);
