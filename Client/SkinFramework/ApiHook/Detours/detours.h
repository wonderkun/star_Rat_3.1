...
#if defined(XTP_SKINFRAMEWORK_USE_DETOURS_API_HOOK) && !defined(_DETOURS_H_)
#	define _DETOURS_H_

#	if defined(__cplusplus) && !defined(DETOURS_INTERNAL)
...
#		ifndef _CRT_STDIO_ARBITRARY_WIDE_SPECIFIERS
#			define _CRT_STDIO_ARBITRARY_WIDE_SPECIFIERS 1
#		elif _CRT_STDIO_ARBITRARY_WIDE_SPECIFIERS != 1
#			error _CRT_STDIO_ARBITRARY_WIDE_SPECIFIERS is already defined with a different value.
#		endif
...
C_ASSERT(DETOUR_IA64_TEMPLATE_SIZE
...
#endif // defined(XTP_SKINFRAMEWORK_USE_DETOURS_API_HOOK ) && !defined(_DETOURS_H_)
