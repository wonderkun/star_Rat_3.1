...
void CXTPSkinManagerSchema::DrawThemeFrame(CDC* pDC, CXTPSkinObjectFrame* pFrame)
{
...

	{
		...
		pClassWindow->DrawThemeBackground(&dc, bToolWindow? WP_SMALLCAPTION:
			dwStyle & WS_MAXIMIZE ? WP_MAXCAPTION :
			dwStyle & WS_MINIMIZE ? WP_MINCAPTION : WP_CAPTION, nFrameState, rcCaption);
