...
static const struct TMS_SCHEMA_ENTRY gSchemaStateCodes[] = {
	_T("FRAME_ACTIVE"), 1, _T("FRAME_INACTIVE"), 2,

	_T("CAPTION_ACTIVE"), 1, _T("CAPTION_INACTIVE"), 2, _T("CAPTION_DISABLED"), 3,

	_T("MAXCAPTION_ACTIVE"), 1, _T("MAXCAPTION_INACTIVE"), 2, _T("MAXCAPTION_DISABLED"), 3,

	_T("MINCAPTION_ACTIVE"), 1, _T("MINCAPTION_INACTIVE"), 2, _T("MINCAPTION_DISABLED"), 3,

	_T("HORZSCROLL_NORMAL"), 1, _T("HORZSCROLL_HOT"), 2, _T("HORZSCROLL_PUSHED"), 3,
	_T("HORZSCROLL_DISABLED"), 4,

	_T("HORZTHUMB_NORMAL"), 1, _T("HORZTHUMB_HOT"), 2, _T("HORZTHUMB_PUSHED"), 3,
	_T("HORZTHUMB_DISABLED"), 4,

	_T("VERTSCROLL_NORMAL"), 1, _T("VERTSCROLL_HOT"), 2, _T("VERTSCROLL_PUSHED"), 3,
	_T("VERTSCROLL_DISABLED"), 4,

	_T("VERTTHUMB_NORMAL"), 1, _T("VERTTHUMB_HOT"), 2, _T("VERTTHUMB_PUSHED"), 3,
	_T("VERTTHUMB_DISABLED"), 4,

	_T("SYSBUTTON_NORMAL"), 1, _T("SYSBUTTON_HOT"), 2, _T("SYSBUTTON_PUSHED"), 3,
	_T("SYSBUTTON_DISABLED"), 4,

	_T("MINBUTTON_NORMAL"), 1, _T("MINBUTTON_HOT"), 2, _T("MINBUTTON_PUSHED"), 3,
	_T("MINBUTTON_DISABLED"), 4,

	_T("MAXBUTTON_NORMAL"), 1, _T("MAXBUTTON_HOT"), 2, _T("MAXBUTTON_PUSHED"), 3,
	_T("MAXBUTTON_DISABLED"), 4,

	_T("RESTOREBUTTON_NORMAL"), 1, _T("RESTOREBUTTON_HOT"), 2, _T("RESTOREBUTTON_PUSHED"), 3,
	_T("RESTOREBUTTON_DISABLED"), 4,

	_T("HELPBUTTON_NORMAL"), 1, _T("HELPBUTTON_HOT"), 2, _T("HELPBUTTON_PUSHED"), 3,
	_T("HELPBUTTON_DISABLED"), 4,

	_T("CLOSEBUTTON_NORMAL"), 1, _T("CLOSEBUTTON_HOT"), 2, _T("CLOSEBUTTON_PUSHED"), 3,
	_T("CLOSEBUTTON_DISABLED"), 4,

	_T("PUSHBUTTON_NORMAL"), 1, _T("PUSHBUTTON_HOT"), 2, _T("PUSHBUTTON_PRESSED"), 3,
	_T("PUSHBUTTON_DISABLED"), 4, _T("PUSHBUTTON_DEFAULTED"), 5,

	_T("RADIOBUTTON_UNCHECKEDNORMAL"), 1, _T("RADIOBUTTON_UNCHECKEDHOT"), 2,
	_T("RADIOBUTTON_UNCHECKEDPRESSED"), 3, _T("RADIOBUTTON_UNCHECKEDDISABLED"), 4,
	_T("RADIOBUTTON_CHECKEDNORMAL"), 5, _T("RADIOBUTTON_CHECKEDHOT"), 6,
	_T("RADIOBUTTON_CHECKEDPRESSED"), 7, _T("RADIOBUTTON_CHECKEDDISABLED"), 8,

	_T("CHECKBOX_UNCHECKEDNORMAL"), 1, _T("CHECKBOX_UNCHECKEDHOT"), 2,
	_T("CHECKBOX_UNCHECKEDPRESSED"), 3, _T("CHECKBOX_UNCHECKEDDISABLED"), 4,
	_T("CHECKBOX_CHECKEDNORMAL"), 5, _T("CHECKBOX_CHECKEDHOT"), 6, _T("CHECKBOX_CHECKEDPRESSED"), 7,
	_T("CHECKBOX_CHECKEDDISABLED"), 8, _T("CHECKBOX_MIXEDNORMAL"), 9, _T("CHECKBOX_MIXEDHOT"), 10,
	_T("CHECKBOX_MIXEDPRESSED"), 11, _T("CHECKBOX_MIXEDDISABLED"), 12,

	_T("GROUPBOX_NORMAL"), 1, _T("GROUPBOX_DISABLED"), 2,

	//---------------------------------------------------------------------------------------
	//   "Rebar" Parts & States
	//---------------------------------------------------------------------------------------

	_T("CHEVRON_NORMAL"), 1, _T("CHEVRON_HOT"), 2, _T("CHEVRON_PRESSED"), 3,

	//---------------------------------------------------------------------------------------
	//   "Toolbar" Parts & States
	//---------------------------------------------------------------------------------------

	_T("TOOLBAR_NORMAL"), 1, _T("TOOLBAR_HOT"), 2, _T("TOOLBAR_PRESSED"), 3, _T("TOOLBAR_DISABLED"),
	4, _T("TOOLBAR_CHECKED"), 5, _T("TOOLBAR_HOTCHECKED"), 6,

	//---------------------------------------------------------------------------------------
	//   "Menu" Parts & States
	//---------------------------------------------------------------------------------------

	_T("MENU_NORMAL"), 1, _T("MENU_SELECTED"), 2, _T("MENU_DEMOTED"), 3,

	_T("BARBACKGROUND_ACTIVE"), 1, _T("BARBACKGROUND_INACTIVE"), 2,

	_T("POPUPCHECK_CHECKMARKNORMAL"), 1, _T("POPUPCHECK_CHECKMARKDISABLED"), 2,
	_T("POPUPCHECK_BULLETNORMAL"), 3, _T("POPUPCHECK_BULLETDISABLED"), 4,

	_T("POPUPCHECKBACKGROUND_DISABLED"), 1, _T("POPUPCHECKBACKGROUND_NORMAL"), 2,
	_T("POPUPCHECKBACKGROUND_BITMAP"), 3,

	_T("POPUPITEM_NORMAL"), 1, _T("POPUPITEM_HOT"), 2, _T("POPUPITEM_DISABLED"), 3,
	_T("POPUPITEM_DISABLEDHOT"), 4,

	_T("POPUPSUBMENU_NORMAL"), 1, _T("POPUPSUBMENU_DISABLED"), 2,

	//---------------------------------------------------------------------------------------
	//   "ListView" Parts & States
	//---------------------------------------------------------------------------------------

	_T("LISTITEM_NORMAL"), 1, _T("LISTITEM_HOT"), 2, _T("LISTITEM_SELECTED"), 3,
	_T("LISTITEM_DISABLED"), 4, _T("LISTITEM_SELECTEDNOTFOCUS"), 5,

	//---------------------------------------------------------------------------------------
	//   "Header" Parts & States
	//---------------------------------------------------------------------------------------

	_T("HEADERITEM_NORMAL"), 1, _T("HEADERITEM_HOT"), 2, _T("HEADERITEM_PRESSED"), 3,

	_T("HEADERITEMLEFT_NORMAL"), 1, _T("HEADERITEMLEFT_HOT"), 2, _T("HEADERITEMLEFT_PRESSED"), 3,

	_T("HEADERITEMRIGHT_NORMAL"), 1, _T("HEADERITEMRIGHT_HOT"), 2, _T("HEADERITEMRIGHT_PRESSED"), 3,

	_T("HEADERSORTARROW_SORTEDUP"), 1, _T("HEADERSORTARROW_SORTEDDOWN"), 2,

	//---------------------------------------------------------------------------------------
	//   "Tab" Parts & States
	//---------------------------------------------------------------------------------------

	_T("TABITEM_NORMAL"), 1, _T("TABITEM_HOT"), 2, _T("TABITEM_SELECTED"), 3,
	_T("TABITEM_DISABLED"), 4, _T("TABITEM_FOCUSED"), 5,

	_T("TABITEMLEFTEDGE_NORMAL"), 1, _T("TABITEMLEFTEDGE_HOT"), 2, _T("TABITEMLEFTEDGE_SELECTED"),
	3, _T("TABITEMLEFTEDGE_DISABLED"), 4, _T("TABITEMLEFTEDGE_FOCUSED"), 5,

	_T("TABITEMRIGHTEDGE_NORMAL"), 1, _T("TABITEMRIGHTEDGE_HOT"), 2,
	_T("TABITEMRIGHTEDGE_SELECTED"), 3, _T("TABITEMRIGHTEDGE_DISABLED"), 4,
	_T("TABITEMRIGHTEDGE_FOCUSED"), 5,

	_T("TABITEMBOTHEDGES_NORMAL"), 1, _T("TABITEMBOTHEDGES_HOT"), 2,
	_T("TABITEMBOTHEDGES_SELECTED"), 3, _T("TABITEMBOTHEDGES_DISABLED"), 4,
	_T("TABITEMBOTHEDGES_FOCUSED"), 5,

	_T("TOPTABITEM_NORMAL"), 1, _T("TOPTABITEM_HOT"), 2, _T("TOPTABITEM_SELECTED"), 3,
	_T("TOPTABITEM_DISABLED"), 4, _T("TOPTABITEM_FOCUSED"), 5,

	_T("TOPTABITEMLEFTEDGE_NORMAL"), 1, _T("TOPTABITEMLEFTEDGE_HOT"), 2,
	_T("TOPTABITEMLEFTEDGE_SELECTED"), 3, _T("TOPTABITEMLEFTEDGE_DISABLED"), 4,
	_T("TOPTABITEMLEFTEDGE_FOCUSED"), 5,

	_T("TOPTABITEMRIGHTEDGE_NORMAL"), 1, _T("TOPTABITEMRIGHTEDGE_HOT"), 2,
	_T("TOPTABITEMRIGHTEDGE_SELECTED"), 3, _T("TOPTABITEMRIGHTEDGE_DISABLED"), 4,
	_T("TOPTABITEMRIGHTEDGE_FOCUSED"), 5,

	_T("TOPTABITEMBOTHEDGES_NORMAL"), 1, _T("TOPTABITEMBOTHEDGES_HOT"), 2,
	_T("TOPTABITEMBOTHEDGES_SELECTED"), 3, _T("TOPTABITEMBOTHEDGES_DISABLED"), 4,
	...
	_T("THUMB_NORMAL"), 1, _T("THUMB_HOT"), 2, _T("THUMB_PRESSED"), 3, _T("THUMB_FOCUSED"), 4,
	_T("THUMB_DISABLED"), 5,

	_T("THUMBBOTTOM_NORMAL"), 1, _T("THUMBBOTTOM_HOT"), 2, _T("THUMBBOTTOM_PRESSED"), 3,
	_T("THUMBBOTTOM_FOCUSED"), 4, _T("THUMBBOTTOM_DISABLED"), 5,

	_T("THUMBTOP_NORMAL"), 1, _T("THUMBTOP_HOT"), 2, _T("THUMBTOP_PRESSED"), 3,
	_T("THUMBTOP_FOCUSED"), 4, _T("THUMBTOP_DISABLED"), 5,

	_T("THUMBVERT_NORMAL"), 1, _T("THUMBVERT_HOT"), 2, _T("THUMBVERT_PRESSED"), 3,
	_T("THUMBVERT_FOCUSED"), 4, _T("THUMBVERT_DISABLED"), 5,

	_T("THUMBLEFT_NORMAL"), 1, _T("THUMBLEFT_HOT"), 2, _T("THUMBLEFT_PRESSED"), 3,
	_T("THUMBLEFT_FOCUSED"), 4, _T("THUMBLEFT_DISABLED"), 5,

	_T("THUMBRIGHT_NORMAL"), 1, _T("THUMBRIGHT_HOT"), 2, _T("THUMBRIGHT_PRESSED"), 3,
	_T("THUMBRIGHT_FOCUSED"), 4, _T("THUMBRIGHT_DISABLED"), 5,
	...
	_T("CLOSE_NORMAL"), 1, _T("CLOSE_HOT"), 2, _T("CLOSE_PRESSED"), 3,

	_T("STANDARD_NORMAL"), 1, _T("STANDARD_LINK"), 2,

	_T("BALLOON_NORMAL"), 1, _T("BALLOON_LINK"), 2,

	//---------------------------------------------------------------------------------------
	//   "TreeView" Parts & States
	//---------------------------------------------------------------------------------------

	_T("TREEITEM_NORMAL"), 1, _T("TREEITEM_HOT"), 2, _T("TREEITEM_SELECTED"), 3,
	_T("TREEITEM_DISABLED"), 4, _T("TREEITEM_SELECTEDNOTFOCUS"), 5,

	_T("GLYPH_CLOSED"), 1, _T("GLYPH_OPENED"), 2,

	//---------------------------------------------------------------------------------------
	//   "Spin" Parts & States
	//---------------------------------------------------------------------------------------

	_T("UP_NORMAL"), 1, _T("UP_HOT"), 2, _T("UP_PRESSED"), 3, _T("UP_DISABLED"), 4,

	_T("DOWN_NORMAL"), 1, _T("DOWN_HOT"), 2, _T("DOWN_PRESSED"), 3, _T("DOWN_DISABLED"), 4,

	_T("UPHORZ_NORMAL"), 1, _T("UPHORZ_HOT"), 2, _T("UPHORZ_PRESSED"), 3, _T("UPHORZ_DISABLED"), 4,

	_T("DOWNHORZ_NORMAL"), 1, _T("DOWNHORZ_HOT"), 2, _T("DOWNHORZ_PRESSED"), 3,
	...
	_T("ARROWBTN_UPNORMAL"), 1, _T("ARROWBTN_UPHOT"), 2, _T("ARROWBTN_UPPRESSED"), 3,
	_T("ARROWBTN_UPDISABLED"), 4, _T("ARROWBTN_DOWNNORMAL"), 5, _T("ARROWBTN_DOWNHOT"), 6,
	_T("ARROWBTN_DOWNPRESSED"), 7, _T("ARROWBTN_DOWNDISABLED"), 8, _T("ARROWBTN_LEFTNORMAL"), 9,
	_T("ARROWBTN_LEFTHOT"), 10, _T("ARROWBTN_LEFTPRESSED"), 11, _T("ARROWBTN_LEFTDISABLED"), 12,
	_T("ARROWBTN_RIGHTNORMAL"), 13, _T("ARROWBTN_RIGHTHOT"), 14, _T("ARROWBTN_RIGHTPRESSED"), 15,
	_T("ARROWBTN_RIGHTDISABLED"), 16,

	_T("SCROLLBAR_NORMAL"), 1, _T("SCROLLBAR_HOT"), 2, _T("SCROLLBAR_PRESSED"), 3,
	_T("SCROLLBAR_DISABLED"), 4, _T("SCROLLBAR_ACTIVE"), 5,

	_T("SIZEBOX_RIGHTALIGN"), 1, _T("SIZEBOX_LEFTALIGN"), 2,

	//---------------------------------------------------------------------------------------
	//   "Edit" Parts & States
	//---------------------------------------------------------------------------------------

	_T("EDITTEXT_NORMAL"), 1, _T("EDITTEXT_HOT"), 2, _T("EDITTEXT_SELECTED"), 3,
	_T("EDITTEXT_DISABLED"), 4, _T("EDITTEXT_FOCUSED"), 5, _T("EDITTEXT_READONLY"), 6,
	...
	_T("COMBOBOX_NORMAL"), 1, _T("COMBOBOX_HOT"), 2, _T("COMBOBOX_PRESSED"), 3,
	...
	_T("MOREPROGRAMSARROW_NORMAL"), 1, _T("MOREPROGRAMSARROW_HOT"), 2,
	_T("MOREPROGRAMSARROW_PRESSED"), 3,

	_T("LOGOFFBUTTONS_NORMAL"), 1, _T("LOGOFFBUTTONS_HOT"), 2, _T("LOGOFFBUTTONS_PRESSED"), 3,

	//---------------------------------------------------------------------------------------
	//   "ExplorerBar" Parts & States
	//---------------------------------------------------------------------------------------

	_T("HEADERCLOSE_NORMAL"), 1, _T("HEADERCLOSE_HOT"), 2, _T("HEADERCLOSE_PRESSED"), 3,

	_T("HEADERPIN_NORMAL"), 1, _T("HEADERPIN_HOT"), 2, _T("HEADERPIN_PRESSED"), 3,
	_T("HEADERPIN_SELECTEDNORMAL"), 4, _T("HEADERPIN_SELECTEDHOT"), 5,
	_T("HEADERPIN_SELECTEDPRESSED"), 6,

	_T("IEBARMENU_NORMAL"), 1, _T("IEBARMENU_HOT"), 2, _T("IEBARMENU_PRESSED"), 3,

	_T("NORMALGROUPCOLLAPSE_NORMAL"), 1, _T("NORMALGROUPCOLLAPSE_HOT"), 2,
	_T("NORMALGROUPCOLLAPSE_PRESSED"), 3,

	_T("NORMALGROUPEXPAND_NORMAL"), 1, _T("NORMALGROUPEXPAND_HOT"), 2,
	_T("NORMALGROUPEXPAND_PRESSED"), 3,

	_T("SPECIALGROUPCOLLAPSE_NORMAL"), 1, _T("SPECIALGROUPCOLLAPSE_HOT"), 2,
	_T("SPECIALGROUPCOLLAPSE_PRESSED"), 3,

	_T("SPECIALGROUPEXPAND_NORMAL"), 1, _T("SPECIALGROUPEXPAND_HOT"), 2,
	...
	_T("MENUBAND_NORMAL"), 1, _T("MENUBAND_HOT"), 2, _T("MENUBAND_PRESSED"), 3,
	_T("MENUBAND_DISABLED"), 4, _T("MENUBAND_CHECKED"), 5, _T("MENUBAND_HOTCHECKED"), 6,
...
#		define TM_PROP(val, prefix, name, primval)                                                \
			L"P_" L#name, PROPERTY_N(val, XTP_SKINPROPERTY_##primval),
#	else
#		define TM_PROP(val, prefix, name, primval)                                                \
			"P_" #name, PROPERTY_N(val, XTP_SKINPROPERTY_##primval),
#	endif
...
static const struct TMS_SCHEMA_ENTRY gSchemaPropertyCodes[] = {
	...
	//---- primitive types ----
	TM_PROP(201, TMT, STRING, STRING) TM_PROP(202, TMT, INT, INT) TM_PROP(203, TMT, BOOL, BOOL)
		TM_PROP(204, TMT, COLOR, COLOR) TM_PROP(205, TMT, MARGINS, MARGINS)
			TM_PROP(206, TMT, FILENAME, FILENAME) TM_PROP(207, TMT, SIZE, SIZE)
				TM_PROP(208, TMT, POSITION, POSITION) TM_PROP(209, TMT, RECT, RECT)
					TM_PROP(210, TMT, FONT, FONT) TM_PROP(211, TMT, INTLIST, INTLIST)

	//---- special misc. properties ----
	TM_PROP(401, TMT, COLORSCHEMES, STRING) TM_PROP(402, TMT, SIZES, STRING)
		TM_PROP(403, TMT, CHARSET, INT)

	//---- [documentation] properties ----

	TM_PROP(601, TMT, DISPLAYNAME, STRING) TM_PROP(602, TMT, TOOLTIP, STRING)
		TM_PROP(603, TMT, COMPANY, STRING) TM_PROP(604, TMT, AUTHOR, STRING)
			TM_PROP(605, TMT, COPYRIGHT, STRING) TM_PROP(606, TMT, URL, STRING)
				TM_PROP(607, TMT, VERSION, STRING) TM_PROP(608, TMT, DESCRIPTION, STRING)

	//---- theme metrics: fonts ----

	TM_PROP(801, TMT, CAPTIONFONT, FONT) TM_PROP(802, TMT, SMALLCAPTIONFONT, FONT)
		TM_PROP(803, TMT, MENUFONT, FONT) TM_PROP(804, TMT, STATUSFONT, FONT)
			TM_PROP(805, TMT, MSGBOXFONT, FONT) TM_PROP(806, TMT, ICONTITLEFONT, FONT)
	...
	TM_PROP(1201, TMT, SIZINGBORDERWIDTH, SIZE) TM_PROP(1202, TMT, SCROLLBARWIDTH, SIZE)
		TM_PROP(1203, TMT, SCROLLBARHEIGHT, SIZE) TM_PROP(1204, TMT, CAPTIONBARWIDTH, SIZE)
			TM_PROP(1205, TMT, CAPTIONBARHEIGHT, SIZE) TM_PROP(1206, TMT, SMCAPTIONBARWIDTH, SIZE)
				TM_PROP(1207, TMT, SMCAPTIONBARHEIGHT, SIZE) TM_PROP(1208, TMT, MENUBARWIDTH, SIZE)
	...
	TM_PROP(1401, TMT, CSSNAME, STRING) TM_PROP(1402, TMT, XMLNAME, STRING)

	//---- theme metrics: colors ----

	TM_PROP(1601, TMT, SCROLLBAR, COLOR) TM_PROP(1602, TMT, BACKGROUND,
												 COLOR) TM_PROP(1603, TMT, ACTIVECAPTION, COLOR)
		TM_PROP(1604, TMT, INACTIVECAPTION, COLOR) TM_PROP(1605, TMT, MENU,
														   COLOR) TM_PROP(1606, TMT, WINDOW, COLOR)
			TM_PROP(1607, TMT, WINDOWFRAME,
					COLOR) TM_PROP(1608, TMT, MENUTEXT, COLOR) TM_PROP(1609, TMT, WINDOWTEXT, COLOR)
				TM_PROP(1610, TMT, CAPTIONTEXT, COLOR) TM_PROP(1611, TMT, ACTIVEBORDER, COLOR)
					TM_PROP(1612, TMT, INACTIVEBORDER, COLOR) TM_PROP(
						1613, TMT, APPWORKSPACE, COLOR) TM_PROP(1614, TMT, HIGHLIGHT, COLOR)
						TM_PROP(1615, TMT, HIGHLIGHTTEXT, COLOR) TM_PROP(1616, TMT, BTNFACE, COLOR)
							TM_PROP(1617, TMT, BTNSHADOW, COLOR) TM_PROP(1618, TMT, GRAYTEXT, COLOR)
								TM_PROP(1619, TMT, BTNTEXT,
										COLOR) TM_PROP(1620, TMT, INACTIVECAPTIONTEXT, COLOR)
									TM_PROP(1621, TMT, BTNHIGHLIGHT,
											COLOR) TM_PROP(1622, TMT, DKSHADOW3D,
														   COLOR) TM_PROP(1623, TMT, LIGHT3D, COLOR)
										TM_PROP(1624, TMT, INFOTEXT,
												COLOR) TM_PROP(1625, TMT, INFOBK, COLOR)
											TM_PROP(1626, TMT, BUTTONALTERNATEFACE, COLOR)
												TM_PROP(1627, TMT, HOTTRACKING, COLOR)
													TM_PROP(1628, TMT, GRADIENTACTIVECAPTION, COLOR)
														TM_PROP(1629, TMT, GRADIENTINACTIVECAPTION,
																COLOR)
															TM_PROP(1630, TMT, MENUHILIGHT, COLOR)
																TM_PROP(1631, TMT, MENUBAR, COLOR)

	//---- hue substitutions ----
	TM_PROP(1801, TMT, FROMHUE1, INT) TM_PROP(1802, TMT, FROMHUE2, INT)
		TM_PROP(1803, TMT, FROMHUE3, INT) TM_PROP(1804, TMT, FROMHUE4, INT)
			TM_PROP(1805, TMT, FROMHUE5, INT) TM_PROP(1806, TMT, TOHUE1, INT)
				TM_PROP(1807, TMT, TOHUE2, INT) TM_PROP(1808, TMT, TOHUE3, INT)
					TM_PROP(1809, TMT, TOHUE4, INT) TM_PROP(1810, TMT, TOHUE5, INT)

	//---- color substitutions ----
	TM_PROP(2001, TMT, FROMCOLOR1, COLOR) TM_PROP(2002, TMT, FROMCOLOR2, COLOR)
		TM_PROP(2003, TMT, FROMCOLOR3, COLOR) TM_PROP(2004, TMT, FROMCOLOR4, COLOR)
			TM_PROP(2005, TMT, FROMCOLOR5, COLOR) TM_PROP(2006, TMT, TOCOLOR1, COLOR)
				TM_PROP(2007, TMT, TOCOLOR2, COLOR) TM_PROP(2008, TMT, TOCOLOR3, COLOR)
					TM_PROP(2009, TMT, TOCOLOR4, COLOR) TM_PROP(2010, TMT, TOCOLOR5, COLOR)
	...
	TM_PROP(2206, TMT, GLYPHTRANSPARENT,
			BOOL)						// glyph has transparent areas (see GlyphTransparentColor)
	TM_PROP(2207, TMT, GLYPHONLY, BOOL) // only draw glyph (not background)
	TM_PROP(2208, TMT, ALWAYSSHOWSIZINGBAR, BOOL)
		TM_PROP(2209, TMT, MIRRORIMAGE,
				BOOL) // default=TRUE means image gets mirrored in RTL (Mirror) windows
	TM_PROP(2210, TMT, UNIFORMSIZING, BOOL) // if TRUE, height & width must be uniformly sized
	TM_PROP(2211, TMT, INTEGRALSIZING,
			BOOL) // for TRUESIZE and Border sizing; if TRUE, factor must be integer
	...
	TM_PROP(2406, TMT, GRADIENTRATIO1,
			INT) // (0-255) - amt of gradient color 1 to use (all must total=255)
	TM_PROP(2407, TMT, GRADIENTRATIO2,
			INT) // (0-255) - amt of gradient color 2 to use (all must total=255)
	TM_PROP(2408, TMT, GRADIENTRATIO3,
			INT) // (0-255) - amt of gradient color 3 to use (all must total = 255)
	TM_PROP(2409, TMT, GRADIENTRATIO4,
			INT) // (0-255) - amt of gradient color 4 to use (all must total=255)
	TM_PROP(2410, TMT, GRADIENTRATIO5,
			INT) // (0-255) - amt of gradient color 5 to use (all must total=255)
	...
	TM_PROP(2419, TMT, TRUESIZESTRETCHMARK,
			INT) // stretch TrueSize image when target exceeds source by this percent
	...
	TM_PROP(3001, TMT, IMAGEFILE,
			FILENAME) // the filename of the image (or basename, for mult. images)
	...
	TM_PROP(3007, TMT, STOCKIMAGEFILE,
			FILENAME) // These are the only images that you can call GetThemeBitmap on
	...
	TM_PROP(3402, TMT, TEXTSHADOWOFFSET,
			POSITION)					   // where char shadows are drawn, relative to orig. chars
	...
	TM_PROP(3603, TMT, CAPTIONMARGINS,
			MARGINS) // margins that define where caption text can be placed
	...
	TM_PROP(3809, TMT, TRANSPARENTCOLOR,
			COLOR) // color of pixels that are treated as transparent (not drawn)
	...
	TM_PROP(3820, TMT, GLYPHTRANSPARENTCOLOR,
			COLOR)							   // color of transparent pixels in GlyphImageFile
	...
	TM_PROP(4013, TMT, IMAGESELECTTYPE,
			ENUM) // controls when to select from IMAGEFILE1...IMAGEFILE5
	TM_PROP(4014, TMT, GLYPHFONTSIZINGTYPE,
			ENUM) // controls when to select a bigger/small glyph font size
	...
	TM_PROP(5001, TMT, USERPICTURE, BOOL) TM_PROP(5002, TMT, DEFAULTPANESIZE, RECT)
...
#	define GET_CLASS_CODE(cls)                                                                    \
		CXTPSkinManagerSchemaCodeManager::MapKey(gSchemaClassAndPartsCodes, cls)
#	define GET_ENUM_CODE(prop, val)                                                               \
		CXTPSkinManagerSchemaCodeManager::MapKey2(gSchemaEnumCodes, prop, val)
#	define GET_CLASSPART_CODE(cls, part)                                                          \
		CXTPSkinManagerSchemaCodeManager::MapKey2(gSchemaClassAndPartsCodes, cls, part)
#	define GET_STATE_CODE(part, state)                                                            \
		CXTPSkinManagerSchemaCodeManager::MapKey2(gSchemaStateCodes, part, state)
#	define GET_PROPERTY_CODE(prop)                                                                \
		CXTPSkinManagerSchemaCodeManager::MapKey(gSchemaPropertyCodes, prop, _T("P_"))
