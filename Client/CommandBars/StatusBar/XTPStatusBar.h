...
public:
	...
	// Parameters:
	//     pParentWnd - Pointer to the CWnd object whose Windows window is the parent of the status
	//     bar. dwStyle    - The status-bar style. In addition to the standard Windows styles, these
	//     styles are supported nID        - The toolbar's child-window ID
	// Returns:
...
public:
	...
	// Parameters:
	//     pParentWnd - Pointer to the CWnd object whose Windows window is the parent of the status
	//     bar. dwCtrlStyle - Additional styles for the creation of the embedded CStatusBarCtrl
	//     object. dwStyle - The status-bar style nID - The status bar's child-window ID.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Copies the coordinates of the indicator specified by nIndex into the structure pointed to
	//     by lpRect. Coordinates are in pixels relative to the upper-left corner of the status bar.
	// Parameters:
	//     nIndex - Index of the indicator whose rectangle coordinates are to be retrieved.
	//     lpRect - Points to aRECT structure or a CRect object that will receive the coordinates of
	//     the indicator specified by nIndex.
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to retrieve the style of a status bar's pane. A pane's style
	//     determines how the pane appears.
	// Parameters:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Call this member function to set the style of a status bar's pane. A pane's style
	//     determines how the pane appears.
	// Parameters:
