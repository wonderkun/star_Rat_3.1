...
//////////////////////////////////////////////////////////////////////////
// CControlPageSelector

class CControlPageSelector : public CXTPControlSelector
{
public:
	CControlPageSelector();
...
CControlPageSelector::CControlPageSelector()
{
...
void CControlPageSelector::OnDrawItem(CDC* pDC, CRect rcItem, COLORREF clrText)
{
...
int CXTPPreviewView::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	pTwoPages->GetCommandBar()->GetControls()->Add(new CControlPageSelector(), XTP_ID_PREVIEW_TWOPAGE);
