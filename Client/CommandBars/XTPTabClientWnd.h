...
//-----------------------------------------------------------------------
// Summary:
//     The WM_XTP_GETWINDOWTEXT message is sent to MDI child window to retrieve text will be used
...
//-----------------------------------------------------------------------
// Summary:
//     The WM_XTP_GETWINDOWTOOLTIP message is sent to MDI child window to retrieve tooltips for
//     CXTPTabClientWnd's tabs.
// Remarks:
...
public:
	...
	//                      active tab
	//     activeTab - Enumerator that determine which tab will be activated after closing another
	//     one.
	//                 It can be one of the following
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     This method is called to create new CWorkspace class, you can override it for custom
	//     Workskspace.
	//-----------------------------------------------------------------------
	...
	// Parameters:
	//     nID - Specifies the identifier of the workspace. Can be any of the values listed in the
	//     Remarks section.
	// Remarks:
	...
	//-----------------------------------------------------------------------
	// Summary:
	//     Converts the screen coordinates of a given point or rectangle on the display to client
	//     coordinates.
	// Parameters:
...
protected:
	...
	BOOL m_bThemedBackColor; // TRUE if a themed backcolor will be used.  If TRUE, then the
							 // backcolor of the MDIClient is calculated from current theme, if
							 // FALSE the standard BackColor property will be used
	...
	BOOL m_bUseSplitterTracker; // If TRUE, splitter trackers are used.  When resizing a workspace,
								...
								// If FALSE, the workspace will be resized in "real-time."
