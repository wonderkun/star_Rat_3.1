...
public:
	...
	// Parameters:
	//      bScaleGalleryItems - TRUE to enable gallery items scaling (default), or FALSE to
	//      disable. bScaleToolbarIcons - TRUE to enable toolbar icon scaling (default), or FALSE to
	//      disable.
	// See also:
...
public:
	...
	BOOL bAutoHideUnusedPopups; // TRUE to hide unused popup controls.  This is similar to how the
								// Windows Start menu hides infrequently used popups.
...
protected:
	...
	BOOL m_bAutoScaleDpiGalleryItems; // TRUE by default. Enables scalling of ribbon gallery items
									  // (both inline and displayed in popup)
	BOOL m_bAutoScaleDpiToolbarIcons; // FALSE by default. Enables scalling of toolbar (on ribbon as
									  // well) buttons icons
