...
void CXTPFlowGraphDrawContext::SelectBrush(COLORREF clr)
{
	if (clr == (COLORREF)-1)
		m_hActiveBrush = 0;
	else
...
void CXTPFlowGraphDrawContext::SelectPen(COLORREF clrPen, int nWidth)
{
	if (m_hActivePen)
	{
...
void CXTPFlowGraphDrawContext::SelectFont(LOGFONT* lf)
{
	if (!lf)
	{
		m_hActiveFont = 0;
