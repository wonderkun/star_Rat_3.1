...
BOOL CSystemDlg::OnInitDialog() 
{
	...
	m_list_windows.InsertColumn(0, "PID", LVCFMT_LEFT, 75);
...
void SetClipboardText2(CString &Data)
{
...
void CSystemDlg::OnDialuCopy()
{
	...
	SetClipboardText2(Data);	
	MessageBox("信息已复制到剪切板","提示", MB_ICONINFORMATION);
}

void CSystemDlg::OnDialu(NMHDR* pNMHDR, LRESULT* pResult) 
{
	// TODO: Add your control notification handler code here
	if (m_list_windows.IsWindowVisible())
		return;
