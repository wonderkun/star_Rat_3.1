...
protected:
	CXTPPaintManagerColor m_clrSelectedWithoutFocus; // color of selected item when TaskPanel lost
													 // focus
	...
	CXTPPaintManagerColor m_clrSelectedTextWithoutFocus; // color of text when item is selected and
														 // TaskPanel lost focus
