...
//===========================================================================
// Summary:
//     The CXTPTaskPanelListViewOffice2003Theme class is used to enable a List View Office 2003
//     style theme.
// See Also:
...
public:
	...
	CXTPPaintManagerColorGradient m_grcHot; // Color gradient used to colorize "hot" items for this
											// theme.
	CXTPPaintManagerColorGradient m_grcPushed; // Color gradient used to colorize "pushed" items for
											   // this theme.
