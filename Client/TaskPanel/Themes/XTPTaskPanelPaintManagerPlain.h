...
protected:
	BOOL m_bRoundedFrame;  // TRUE to draw a rounded frame around all of the groups in the task
						   // panel.  Can bee seen in the Native WinXP theme.  Default is TRUE.
	BOOL m_bOfficeCaption; // FALSE to draw a rounded rectangle around caption.  TRUE to not draw a
						   // rectangle around caption, caption will not appear in a rectrangle.
						   // Default is FALSE.
};
